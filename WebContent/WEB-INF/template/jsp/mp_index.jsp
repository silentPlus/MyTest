...
<html lang="zh-CN">
    ...
    <head>
        ...
        <title ng-clock ng-bind="siteTitle">
        </title>
    ...
    <body ng-controller="indexController" ng-init="initializeController()" ng-class="sidebarToggle">
    	<input type="hidden" id="targetval" value=${message}/>
    	<!--[if lt IE 9]>
                ...
                <div id="nav-wrapper" class="ng-scope">
                    <ul id="nav">
                        <li ng-class="{true:'text-normal active',false:'text-normal'}[btnCtrl.isAuthorize]" ng-click="changeChannel('main/authorize')">
                            ...
                            <i class="fa fa-caret-right icon-has-ul">
                            </i>
                        </li>
...
<%-- 
                        <li ng-class="{true:'text-normal active',false:'text-normal'}[btnCtrl.isQrcode]" ng-click="changeChannel('main/shopqrcode')">
                            <a class="text-success">
...
--%>                  
                        ...
                        <li ng-class="{true:'text-normal active',false:'text-normal'}[btnCtrl.isAcinfo]" ng-click="changeChannel('main/acinfo')">
                            <a class="text-success">
                            	<i class="fa fa-user fa-fw icon-key"></i>
                                <span>
                                账号信息
                                </span>
                            </a>
                        ...
                        <li ng-class="{true:'text-normal active',false:'text-normal'}[btnCtrl.isPwmod]" ng-click="changeChannel('main/pwmod')">
                            <a class="text-success">
                            	<i class="fa fa-key fa-fw icon-key"></i>
                                <span>
                                密码修改
                                </span>
                            </a>
